...
//    @Test
    public void setActivePlateMeasurement() throws Exception {
        ...
        var res2 = performRequest(get("/plates/2000/measurements/2000"), HttpStatus.OK, PlateMeasurementDTO.class);
        Assertions.assertTrue(res2.getMeasurementId().equals(2000L));
        Assertions.assertFalse(res2.getActive());

        res1.setActive(false);
        res2.setActive(true);
        performRequest(put("/plates/2000/measurements/1000", res1), HttpStatus.OK, PlateMeasurementDTO.class);
        performRequest(put("/plates/2000/measurements/2000", res2), HttpStatus.OK, PlateMeasurementDTO.class);

        res1 = performRequest(get("/plates/2000/measurements/1000"), HttpStatus.OK, PlateMeasurementDTO.class);
        Assertions.assertTrue(res1.getMeasurementId().equals(1000L));
        Assertions.assertFalse(res1.getActive());

        res2 = performRequest(get("/plates/2000/measurements/2000"), HttpStatus.OK, PlateMeasurementDTO.class);
        Assertions.assertTrue(res2.getMeasurementId().equals(2000L));
